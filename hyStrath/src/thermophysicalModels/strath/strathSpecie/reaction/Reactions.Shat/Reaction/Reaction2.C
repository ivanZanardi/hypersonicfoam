    ...
    species_(species)
{
    ...
    else if (controllingTemperature == "oxygenDissociationHighT")
    {
        controlT_ = oxygenDissociationHighT;
    }
    else if (controllingTemperature == "oxygenDissociationLowT")
    {
        controlT_ = oxygenDissociationLowT;
    }
    ...
    else
    {
        ...
        (
            ...
            << "  chargeExchange, dissociation, oxygenDissociationHighT,"
            << nl << "oxygenDissociationLowT, exchange, impactDissociation," 
